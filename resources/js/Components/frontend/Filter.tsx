...
export const Filter: React.FC<FilterProps> = ({
    ...
    return (
        <div className="flex gap-8">
            <div className="relative px-4 py-2 border rounded-lg border-slate-300">
                <details className="group [&_summary::-webkit-details-marker]:hidden">
                    <summary className="flex items-center gap-2 transition cursor-pointer text-slate-700 hover:border-gray-600 ">
                    ...
                    <div className="z-50 group-open:absolute group-open:start-0 group-open:top-auto group-open:mt-4">
                        <div className="w-48 bg-white border border-gray-200 rounded-sm">
